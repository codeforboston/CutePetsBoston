...
class TokenResponseData(BaseModel):
    ...
    TokenResponseData
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Token ID.")
    attributes: Optional[TokenResponseDataAttributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "attributes": TokenResponseDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
