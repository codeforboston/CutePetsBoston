...
class TokenResponseDataAttributes(BaseModel):
    """
    TokenResponseDataAttributes
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="Bearer authentication token.")
    expiration: Optional[datetime] = Field(default=None, description="Token expiration timestamp.")
