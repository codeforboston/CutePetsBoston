...
class Organization(BaseModel):
    ...
    Organization
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique organization identifier.")
    type: Optional[StrictStr] = None
    attributes: Optional[OrgAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['orgs']):
            raise ValueError("must be one of enum values ('orgs')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": OrgAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
