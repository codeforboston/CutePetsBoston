...
class SearchRequestData(BaseModel):
    ...
    filter_processing: Optional[StrictStr] = Field(default=None, description="Boolean expression for filter combination.", alias="filterProcessing")
    geodistance: Optional[GeoDistance] = None
    __properties: ClassVar[List[str]] = ["filters", "filterProcessing", "geodistance"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of geodistance
        if self.geodistance:
            _dict['geodistance'] = self.geodistance.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filterProcessing": obj.get("filterProcessing"),
            "geodistance": GeoDistance.from_dict(obj["geodistance"]) if obj.get("geodistance") is not None else None
        })
        return _obj
