...
class ResponseMeta(BaseModel):
    ...
    ResponseMeta
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Total number of matching records.")
    page_count: Optional[StrictInt] = Field(default=None, description="Total number of pages.", alias="pageCount")
    transaction_id: Optional[StrictStr] = Field(default=None, description="Unique transaction identifier for support requests.", alias="transactionId")
    __properties: ClassVar[List[str]] = ["count", "pageCount", "transactionId"]
