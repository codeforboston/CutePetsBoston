...
class Animal(BaseModel):
    ...
    Animal
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique animal identifier.")
    type: Optional[StrictStr] = None
    attributes: Optional[AnimalAttributes] = None
    relationships: Optional[AnimalRelationships] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['animals']):
            raise ValueError("must be one of enum values ('animals')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": AnimalAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": AnimalRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
