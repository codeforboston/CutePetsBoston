...
class AnimalListResponse(BaseModel):
    ...
    data: Optional[List[Animal]] = None
    included: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["meta", "data", "included"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [Animal.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
