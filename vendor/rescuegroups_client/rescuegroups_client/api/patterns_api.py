...
class PatternsApi:
    ...
    def list_animal_patterns(
        ...
        _param = self._list_animal_patterns_serialize(
    ...
    @validate_call
    def list_animal_patterns_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_animal_patterns_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_animal_patterns_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/public/animals/patterns',
