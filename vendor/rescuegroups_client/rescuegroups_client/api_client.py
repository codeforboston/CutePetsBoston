...
from rescuegroups_client.configuration import Configuration
from rescuegroups_client.api_response import ApiResponse, T as ApiResponseT
import rescuegroups_client.models
from rescuegroups_client import rest
from rescuegroups_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(rescuegroups_client.models, klass)
