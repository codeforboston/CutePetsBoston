...
class PosterBluesky(SocialPoster):
    def __init__(self):
        ...
        self.username = os.environ.get("BLUESKY_HANDLE") or os.environ.get("BLUESKY_TEST_HANDLE")
        self.password = os.environ.get("BLUESKY_PASSWORD") or os.environ.get("BLUESKY_TEST_PASSWORD")
